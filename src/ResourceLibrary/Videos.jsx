...
//   const [searchTerm, setSearchTerm] = useState('meditation stress relief');
...
//     all: 'meditation stress relief mental health',
//     meditation: 'meditation mindfulness breathing exercises',
//     awareness: 'mental health awareness anxiety depression',
//     relaxation: 'relaxation techniques stress relief yoga'
//   };

//   // Language mapping for YouTube API
//   const languageMapping = {
//     english: 'en',
//     hindi: 'hi',
//     regional: 'hi' // Using Hindi as default for regional
//   };

//   const fetchYouTubeVideos = async (query, pageToken = null) => {
//     try {
//       setLoading(true);
//       setError(null);

//       const searchQuery = categoryFilter === 'all' ? searchTerm : categoryQueries[categoryFilter];
//       const languageCode = languageFilter !== 'all' ? languageMapping[languageFilter] : null;

//       let apiUrl = `${YOUTUBE_API_URL}/search?part=snippet&type=video&maxResults=12&q=${encodeURIComponent(searchQuery)}&key=${YOUTUBE_API_KEY}`;
...
//           hasSubtitles: true, // YouTube videos generally have captions
//           isOfflineAvailable: false, // YouTube videos are not offline by default
//           instructor: item.snippet.channelTitle,
//           publishedAt: item.snippet.publishedAt
//         };
//       });

//       setVideos(pageToken ? [...videos, ...videosWithDetails] : videosWithDetails);
...
//     {
//       id: 'dummy1',
//       title: "Guided Breathing - 5 mins",
//       description: "Simple breathing exercises to reduce stress and anxiety instantly",
//       duration: "5:30",
//       category: "meditation",
//       language: "Hindi",
//       source: "YouTube",
...
//   useEffect(() => {
//     if (categoryFilter !== 'all' || languageFilter !== 'all') {
//       fetchYouTubeVideos();
//     }
...
//     // Note: Direct downloading from YouTube is not allowed by their ToS
//     alert('YouTube videos cannot be downloaded directly. Please use YouTube Premium for offline viewing.');
//   };

//   const loadMoreVideos = () => {
//     if (nextPageToken) {
//       fetchYouTubeVideos(searchTerm, nextPageToken);
//     }
//   };
...
//             <h1 className="text-3xl font-bold text-gray-800">Mental Health Videos</h1>
//           </div>
...
//                 API Error: {error}. Showing sample data instead.
//               </p>
//             </div>
//           )}
//         </div>
...
//             <strong>✅ YouTube API Integrated:</strong> Now fetching real mental health and wellness videos from YouTube using your API key.
//             Videos open directly on YouTube when clicked.
//           </p>
//         </div>
//       </div>
//     </div>
